        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    ...
                    $(".modal-content").append('<a class="model-href" href="http://xiyounet.org/assets/js/donorList.html">点击查看协会收支记录</p>');
                    $('#mymodal').modal({
                        keyboard: true
                    });
                    $('#mymodal').on('hidden.bs.modal', function (e) {
                        window.location.href = "index-1.htm"/*tpa=http://xiyounet.org/*/;
                    })
                } else {
